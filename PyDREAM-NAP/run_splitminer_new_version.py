...
for eta in range(0, 11):
    ...
    for epsilon in range(0, 11):
        ...
        os.system("java -Djava.awt.headless=true -cp ./split_miner_2.0/sm2.jar:./split_miner_2.0/lib/* au.edu.unimelb.services.ServiceProvider SMD " + str(eta) + " " + str(epsilon) + " true true true " + arguments.log + " " + os.path.join(arguments.output_folder, log_file + "_" + str(eta) + "_" + str(epsilon)))
