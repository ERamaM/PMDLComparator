...
enhanced_pn_folder = "./enhanced_pns_no_resources/"
best_model_folder = "./best_models/"
# Beware of the last slash. NAP does not use os.path.join
model_checkpont_folder = "./model_checkpoints_no_resources"
results_folder = "./results_no_resources"
...
def load_and_process(log_file, type):
    ...
    timedstatesamples_json, tss_objs = enhanced_pn.decay_replay(log_wrapper=log_wrapper)
