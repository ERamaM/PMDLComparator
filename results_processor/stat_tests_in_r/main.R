...
png(paste("../processed_results/latex/next_activity/plots/", metric, "_ranking_boxplot.png", sep=""), width=1100, height=650)
...
write.csv(sorted_probs, paste("../processed_results/csv/next_activity/", metric, "_plackett_sorted_probs.csv", sep=""))
...
write.csv(sorted_rankings, paste("../processed_results/csv/next_activity/", metric, "_plackett_sorted_rankings.csv", sep=""))
...
png(paste("../processed_results/latex/next_activity/plots/", metric, "_best_three_uncertainty.png", sep=""), width=1100, height=650)
...
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_signed_rank_test_", names(index)[1], "_vs_", names(index)[2], ".png")
...
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_signed_rank_test_", names(index)[2], "_vs_", names(index)[3], ".png")
png(paste(filename, collapse=""))
plotSimplex(signed_test, A=names(index)[2], B=names(index)[3], plot.density=FALSE, alpha=0.5)
dev.off()
# Pair 3
signed_test <- bSignedRankTest(best_two, best_three, rope=c(-0.01, 0.01))
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_signed_rank_test_", names(index)[1], "_vs_", names(index)[3], ".png")
png(paste(filename, collapse=""))
...
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_hierarchical_test_", names(index)[1], "_vs_", names(index)[2], ".png")
png(paste(filename, collapse=""))
...
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_hierarchical_test_", names(index)[2], "_vs_", names(index)[3], ".png")
png(paste(filename, collapse=""))
...
filename <- c("../processed_results/latex/next_activity/plots/", metric, "_hierarchical_test_", names(index)[1], "_vs_", names(index)[3], ".png")
png(paste(filename, collapse=""))
...
write.csv(data.frame(results$additional$per.dataset), paste("../processed_results/csv/next_activity/", metric, "_hierarchical_results_per_dataset.csv", sep=""))
